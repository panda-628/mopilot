...
def main_association_relationship(f_relation_file,f_inherit_file,generated_classes,matched_name,name,description,oracle_relationships_list):
    ...
    AI_answer = AI_answer.partition("Final Association Relationships:")[2].partition("# Final Composition Relationships:")[0] + AI_answer.partition("Final Composition Relationships:")[2]
...
def main_inherit_relationship(f_relation_file,f_inherit_file,generated_classes,matched_name,name,description,oracle_relationships_list):
...
def main(temperature):
    ...
    prediction_score_file = f'{path}/{new_folder_cls}/test_each_ex_score.csv' 
    ...
    for name,description,oracle_classes,oracle_relationships in zip(name_list,description_list,oracle_classes_list,oracle_relationships_list):
        ...
        with open(output_classes_file,"w",encoding='UTF-8') as csvfile:
            ...
            for c in range(1,cycle+1):
                ...
                generated_associations_count,matched_associations_count,oracle_associations_count =main_association_relationship(f_relation_file,f_inherit_file,generated_classes,matched_name,name,description,after_parse_oracle_relationships_list)
                
                generated_inheritances_count,matched_inheritances_count,oracle_inheritances_count = main_inherit_relationship(f_relation_file,f_inherit_file,generated_classes,matched_name,name,description,after_parse_oracle_relationships_list)
                ...
                relationship_total_presicion += relationship_presicion
            ...
            average_rela_presicion = relationship_total_presicion /cycle
